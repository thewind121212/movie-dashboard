    ...
    <div class="w-full lg:min-h-[auto] h-auto flex flex-col gap-[2rem] items-center">
        ...
        <Form :validation-schema="validationSchema" @submit="onSubmitFillRegister"
                ...
                <div class="w-full h-auto flex flex-col gap-2">
                    ...
                    <Field name="email" type="email" v-slot="{ field }" :value="email">
                        <input type="email" v-bind="field" readonly disabled
                            class="bg-[#d1d1d1] rounded-[0.75rem] px-[1rem] py-[0.875rem] text-[#6B6B6B] text-[0.875rem] leading-[1.25rem]"
            ...
            <div class="submit-action w-full flex flex-col gap-[0.75rem]">
                <button
                    class="bg-[#121212] rounded-[0.75rem] px-[1rem] py-[0.875rem] text-[#fff] text-[0.875rem] leading-[1.25rem]">Submit</button>
            </div>
        </Form>
    </div>
</template>
