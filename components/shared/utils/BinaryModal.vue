...
<template>
    <div
        class="shadow-[20px_20px_20px_0px_rgba(0,0,0,0.08)] rounded-2xl border border-black p-8 flex flex-col gap-4 justify-center items-center self-stretch relative w-[440px] bg-white h-auto m-auto z-20">
